...
struct bhyveload_env *get_bhyveload_env(struct vm_conf *conf);
struct bhyveload_env *next_bhyveload_env(struct bhyveload_env *be);
char *get_bhyveload_env_env(struct bhyveload_env *be);
